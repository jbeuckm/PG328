...
const char s40[] PROGMEM = "EG1 Key Follow";
...
const char s45[] PROGMEM = "EG2 Key Follow";
...
const byte paramTypes[48] PROGMEM = {
  ...
  TUNE_PARAM, FINE_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, FOUR_VALUE_PARAM, 
  EG_MODE_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, FOUR_VALUE_PARAM, EG_MODE_PARAM, FOUR_VALUE_PARAM, NUMERIC_PARAM, 
  NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, FOUR_VALUE_PARAM, EG_MODE_PARAM, NUMERIC_PARAM, FOUR_VALUE_PARAM, 
  CHORUS, LFO_WAVE, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, 
  FOUR_VALUE_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, NUMERIC_PARAM, FOUR_VALUE_PARAM, NUMERIC_PARAM, VCA_EG_MODE
};
...
PG800::PG800(int ready_pin, int clock_in_pin, int data_out_pin) : paramChanged(48), outBuffer(10) {
  ...
  incValueFunction[XMOD_PARAM] = inc_value_4val;
